...
docker exec -it $GITEA_BACKUPS_CONTAINER sh -c "rm -rf /var/atlassian/application-data/gitea/* && tar -zxpf /srv/gitea-application-data/backups/$SELECTED_APPLICATION_BACKUP -C /"
